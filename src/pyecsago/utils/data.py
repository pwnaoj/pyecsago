...
def generar_datos_sinteticos(num_clusters: int = 10, puntos_por_cluster: int = 50, dimensiones: int = 2, dispersión: float = 0.05, semilla: int | None = None) -> tuple[np.ndarray, np.ndarray]:
    """
